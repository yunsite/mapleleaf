$(document).ready(function() {
	...
	$('#tags li').click(function(){	$('#tags li a').attr('href','javascript:void(0)'); $('#tags li').removeClass('selectTag');  $(this).addClass('selectTag');$('#tagContent div').hide();var indexOfTag=$('#tags li').index(this);$('#'+containerDiv[indexOfTag]).show();$('#'+containerDiv[indexOfTag]+' div').show(); });
