...
CREATE TABLE post (pid INT(10) AUTO_INCREMENT NOT NULL PRIMARY KEY,uid INT(4),uname VARCHAR(30) DEFAULT 'anonymous',content TEXT NOT NULL,post_time INT(11),ip CHAR(15) NOT NULL) ENGINE=MyISAMP DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci
CREATE TABLE reply (rid INT(10) AUTO_INCREMENT NOT NULL PRIMARY KEY,pid INT(10) NOT NULL,content TEXT NOT NULL,r_time INT(11) NOT NULL) ENGINE=MyISAMP DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci
...
INSERT INTO sysvar VALUES ('copyright_info','Copyright © 2010 mapleleaf.ourplanet.tk')
