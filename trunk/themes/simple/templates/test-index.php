                ...
                <table id="main_table">
                    ...
                    <tr>
                        ...
                        <td><div style='word-wrap: break-word;word-break:break-all;width:450px;'><?php echo $m['content'];?><br />
                            <?php if(@$m['reply']){ echo sprintf(ZFramework::t('ADMIN_REPLIED'),date('m-d H:i',(int)$m['reply']['reply_time']+ZFramework::app()->time_zone*60*60),$m['reply']['reply_content']);}?></div>
                        </td>
            ...
            <div class="yui-g">
                ...
                <table id="add_table">
                    <tr>
                        ...
                        <td>
                            <?php if($admin == true){?>
                            <input name="user" id="user" type="hidden" maxlength="10" value="<?php echo ZFramework::app()->admin_name;?>" /><?php echo ZFramework::app()->admin_name;?>
                    ...
                    <tr>
                        ...
                        <td class="left"><input id="valid_code" type="text" name="valid_code" size="4" maxlength="4" />&nbsp;<img id="captcha_img" src="index.php?action=showCaptcha" title="<?php echo ZFramework::t('CLICK_TO_REFRESH');?>" alt="<?php echo ZFramework::t('CAPTCHA');?>" /></td>
                        <td class="left">&nbsp;</td>
                    </tr>
                    <?php }?>
                    <tr>
