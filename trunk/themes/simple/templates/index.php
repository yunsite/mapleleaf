        ...
        <div id="hd">
            <div id="user_nav">
                ...
                if(isset ($_SESSION['user'])){
                    echo '&nbsp;<a class="thickbox" href="index.php?controller=user&amp;action=user_update&amp;uid='.$_SESSION['uid'].'&amp;width=600&amp;height=60%">'.$this->t('UPDATE').'</a>';
                }
                ?>
            </div>
                ...
                <table id="main_table">
                    ...
                    <tr>
                        ...
                        <td><div style='word-wrap: break-word;word-break:break-all;width:450px;'><?php echo $m['content'];?><br />
                            <?php if(@$m['reply']){ echo sprintf($this->t('ADMIN_REPLIED'),date('m-d H:i',(int)$m['reply']['reply_time']+$this->_time_zone*60*60),$m['reply']['reply_content']);}?></div>
                        </td>
