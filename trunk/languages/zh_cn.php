...
return array(
    ...
    'MESSAGE'=>'信息',
    'TIME'=>'时间',
    'PAGE_NAV'=>'共有<span id="totalNum"> %s </span>条留言，共<span id="totalPages"> %s </span>页',
    ...
    'CONFIG_FILE_NOTEXISTS'=>'配置文件 `%s` 不存在! <ul><li>请复制 ./sites/default/default.config.php 为 ./sites/default/config.php.</li><li>更改文件权限让服务器进程可以写入。</li></ul>',
    'CONFIG_FILE_NOTWRITABLE'=>'配置文件 `%s` 不可写入!',
