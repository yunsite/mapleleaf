...
<table id="table1">
	...
	foreach($data as $message)
	{
		...
		// 对表情文件进行解析
		$message[2] = parse_smileys($message[2], "./smileys/images/", $smileys);
...
<table id="table1">
	<tr>
		...
		{
			echo '<input name="user" id="user" type="text" maxlength="10"  onfocus="clear_user()" value="anonymous'.'" />';
		}
		?></td>
		<td class="left">&nbsp;
		<div id="user_msg"></div>
...
<!-- begin footer -->
<div id="botton"><?php echo html_entity_decode($copyright_info);?>&nbsp;
<a href="mailto:<?php echo $admin_email;?>">站长信箱</a> <a
