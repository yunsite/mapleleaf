CREATE TABLE user (uid INT(4) PRIMARY KEY,username VARCHAR(30) NOT NULL,password CHAR(32) NOT NULL,email varchar(70) NOT NULL,reg_time INT(11) NOT NULL)
CREATE TABLE post (pid INT(10) PRIMARY KEY,uid INT(4),uname VARCHAR(30) DEFAULT 'anonymous',content TEXT NOT NULL,post_time INT(11),ip CHAR(15) NOT NULL)
CREATE TABLE reply (rid INT(10) PRIMARY KEY,pid INT(10) NOT NULL,content TEXT NOT NULL,r_time INT(11) NOT NULL)
